...
<body>
<h1>daftar peserta paket dasar komputer</h1>
...
echo "</tr>";
include "koneksi.php";
$tampil=mysqli_query($konek,"select nama_klien,nama_kursus from daftar_klien inner join daftar_kursus on daftar_klien.kode_materi=kode_kursus where kode_materi=2");
$no=1;
